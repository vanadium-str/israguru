...
const SwitchPage = () => {
    ...
    <Switch>
        ...
        <Route path={`/${guidePath}`} render={routerProps => <GuideInfo {...routerProps} idGuide={idGuide} idExcursion={idExcursion} exact/>}/>
        <Route path={`/${fullInfo}`} render={routerProps => <FullInfoExcursion {...routerProps} idGuide={idGuide} idExcursion={idExcursion} exact/>}/>
